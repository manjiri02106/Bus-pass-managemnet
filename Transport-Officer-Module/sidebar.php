...
<aside class="sidebar">
    <?php if ($role === 'admin'): ?>
        ...
        <a href="user_management.php"
            class="sidebar-link <?php echo ($current_page == 'user_management.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-users-gear"></i> User Management
        </a>
        <a href="route_management.php"
            class="sidebar-link <?php echo ($current_page == 'route_management.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-route"></i> Bus Route Management
        </a>
        <a href="bus_management.php"
            class="sidebar-link <?php echo ($current_page == 'bus_management.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-bus"></i> Bus Management
        </a>
        <a href="student_management.php"
            class="sidebar-link <?php echo ($current_page == 'student_management.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-graduation-cap"></i> Student Management
        </a>
        <a href="pass_management.php"
            class="sidebar-link <?php echo ($current_page == 'pass_management.php') ? 'active' : ''; ?>">
        ...
        <a href="notifications.php"
            class="sidebar-link <?php echo ($current_page == 'notifications.php') ? 'active' : ''; ?>">
    ...
    <?php elseif ($role === 'officer'): ?>
        ...
        <a href="officer_dashboard.php"
            class="sidebar-link <?php echo ($current_page == 'officer_dashboard.php' || $current_page == 'verify_application.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-gauge"></i> Dashboard
        </a>
        <a href="officer_dashboard.php?view=pending"
            class="sidebar-link <?php echo (isset($_GET['view']) && $_GET['view'] == 'pending') ? 'active' : ''; ?>">
            <i class="fa-solid fa-user-check"></i> Verify Applications
        </a>
        <a href="officer_dashboard.php?view=approved"
            class="sidebar-link <?php echo (isset($_GET['view']) && $_GET['view'] == 'approved') ? 'active' : ''; ?>">
            <i class="fa-solid fa-signature"></i> Bus Pass Approval
        </a>
        <a href="officer_dashboard.php?view=renewals"
            class="sidebar-link <?php echo (isset($_GET['view']) && $_GET['view'] == 'renewals') ? 'active' : ''; ?>">
    ...
    <?php elseif ($role === 'student'): ?>
        ...
        <a href="student_dashboard.php"
            class="sidebar-link <?php echo ($current_page == 'student_dashboard.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-gauge"></i> Dashboard
        </a>
