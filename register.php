...
<div class="auth-wrapper">
    <div class="glass-card">
        <div class="auth-title">
            <h2 class="text-gradient"><i class="fas fa-user-plus"></i> OmniPass Sign Up</h2>
            <p style="font-size: 14px; color: var(--color-text-muted); margin-top: 5px;">Join OmniPass to apply and manage your daily bus pass.</p>
        </div>
        ...
        <form action="register.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" placeholder="Jane Doe" value="<?= e($name) ?>" required autocomplete="name">
            </div>

            <div class="form-group">
                <label for="email" class="form-label">Email Address</label>
                <input type="email" id="email" name="email" class="form-control" placeholder="jane@domain.com" value="<?= e($email) ?>" required autocomplete="email">
            </div>
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%;"><i class="fas fa-user-check"></i> Register Account</button>
        </form>
