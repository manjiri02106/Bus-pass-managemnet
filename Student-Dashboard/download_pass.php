...
// Fetch approved pass
$q = "SELECT p.*, a.application_no, a.pass_type, a.fee, a.valid_from, a.valid_until, a.college_id_doc, a.photograph_doc, a.address_proof_doc, r.source, r.destination 
      FROM passes p 
      JOIN applications a ON p.application_id = a.id 
      JOIN routes r ON a.route_id = r.id 
      WHERE a.id = ? AND a.student_id = ? AND a.status = 'approved'";
