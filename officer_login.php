            ...
            <div class="col-lg-5">
                <div class="card border-0 rounded-4 shadow-lg bg-secondary-subtle text-dark">
                    <div class="card-body p-4">
                        <h2 class="fw-bold">Transport Officer Access</h2>
                        <p class="text-muted">Sign in to view trips, route analytics, and student scan stats.</p>
                        ...
                        <form method="post" class="mt-3">
                            ...
                            <button class="btn btn-primary w-100">Login as Officer</button>
                        </form>
                        <div class="mt-3">
