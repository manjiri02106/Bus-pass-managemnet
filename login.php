...
<div class="auth-wrapper">
    <div class="glass-card">
        <div class="auth-title">
            <h2 class="text-gradient"><i class="fas fa-bus-alt"></i> OmniPass Sign In</h2>
            <p style="font-size: 14px; color: var(--color-text-muted); margin-top: 5px;">Enter your credentials to manage your transit passes.</p>
        </div>
        ...
        <form action="login.php" method="POST">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="name@domain.com" value="<?= e($email) ?>" required autocomplete="email">
            </div>
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%;"><i class="fas fa-sign-in-alt"></i> Authenticate Account</button>
        </form>
