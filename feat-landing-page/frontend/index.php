        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <p class="hero-description">
                    A smart and secure platform to apply, manage, renew, and track your college transportation bus pass
                    online. Making student transportation easier and more transparent.
                </p>
                    ...
                    <div class="faq-accordion">
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>You can apply for a bus pass through our online portal. Go to the "Apply Now"
                                    section, fill in your details, upload required documents, and submit your
                                    application. Our team will verify and approve it within 2-3 business days.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>You need to provide: Valid college ID, Proof of residence (address),
                                    Government-issued ID, and Recent photograph (passport size).</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>Log in to your account and go to the "Track Status" section. You'll see real-time
                                    updates on your application status.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>Yes! You can renew your bus pass online 30 days before expiry. Simply log in and
                                    click the "Renew Pass" button in your dashboard.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>Once approved, your digital bus pass will be available in your dashboard. Click
                                    "Download" to save it as a PDF file to your device.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-container">
            <div class="footer-column">
                ...
                <p class="footer-description">
                    A comprehensive student transportation management system for managing student bus passes
                    efficiently.
                </p>
            </div>
